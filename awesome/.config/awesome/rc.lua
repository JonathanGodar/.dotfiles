...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "r", restart_awesome, -- l awesome.restart,
              {description = "reload awesome", group = "awesome"}),

    awful.key({ modkey, "Shift"   }, "q", function () awful.spawn.with_shell("rofi -show power-menu -modi \"power-menu:~/scripts/rofi-power-menu.sh --confirm=''\"") end, -- awesome.quit,
    ...
    awful.key({ modkey }, "p", function() menubar.show() end,
		...
		-- Media keys
		awful.key({}, "XF86AudioPlay", function() awful.spawn.with_shell('playerctl play-pause') end, --.with_shell("playerctl playpause") end,
							{}),
		awful.key({}, "XF86AudioNext", function() awful.spawn.with_shell('playerctl next') end, --.with_shell("playerctl playpause") end,
							{}),
		awful.key({}, "XF86AudioPrev", function() awful.spawn.with_shell('playerctl previous') end, --.with_shell("playerctl playpause") end,
							{}),
